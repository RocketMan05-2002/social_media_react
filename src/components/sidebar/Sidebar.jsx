  ...
  return (
    <div className='sidebar'>
      <div className="sidebarWrapper">
        <ul className="sidebarList">
            {
              ...
              ? sidebarLinks.map((item)=>{
                return <li key={item.id} className='sidebarListItem'>
                  {item.icon}
        ...
        <button className='sidebarButton' onClick={()=>setShowMoreToggle(!showMoreToggle)}>
        ...
        <ul className='sidebarFriendList'>
          {
            showMoreToggle2
            ? friends.map((item)=>{
              return <li key={item.id} className='sidebarFriend'>
                <img src={item.profileSrc} alt={item.name} className='sidebarFriendImg' />
        ...
        <button className='sidebarButton' onClick={()=>setShowMoreToggle2(!showMoreToggle2)}>
